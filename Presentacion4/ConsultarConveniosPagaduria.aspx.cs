...
public partial class Presentacion_ConsultarConveniosPagaduria : System.Web.UI.Page
{
    ...
    protected void grvArchivosSoporte_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        try
        {
            ...
            if (Session["idConvPaga"].ToString() != null)
            {
                ...
                MensajeForm("No se ha podido identificar el Convenio", "~/gestion/pagadurias/detalle#irConvenios");
    ...
    protected void GuardarLocalidadesConvenio_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (Session["idConvPaga"] != null)
            {
                ...
                MensajeForm("No se ha podido identificar el convenio al que se le quiere agregar las localidades ", "~/gestion/pagadurias/detalle#irConvenios");
    ...
    protected void lnkBtnBuscarProd_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                MensajeForm("No se ha podido identificar el Convenio. Por favor intentelo nuevamente", "~/gestion/pagadurias/detalle#irConvenios");
            }
