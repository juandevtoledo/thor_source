...
public partial class Presentacion_DetallePagaduria : System.Web.UI.Page
{
    string host;
    DataTable dt, dtTemp;
    string url, jScript;
    ...
    protected void btnEliminar_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            MensajeForm(resDelPag, "~/gestion/pagadurias");
    ...
    {
        Response.RedirectToRoute("gestionPagadurias");
    }
