...
public partial class Presentacion_Reportes_ReporteClientesProductos : System.Web.UI.Page
{
    ...
    protected void btnGenerarReporte_Click(object sender, EventArgs e)
    {
        ...
        DataTable dsReporte = Reporte.GenerarReporteClientesProductos(Utils.ObtenerIdsSeleccionados(lbxCompania), Utils.ObtenerIdsSeleccionados(lbxProducto),
            cedulas, fechaInicio, fechaFin);
        ...
        rvReporte.LocalReport.ReportPath = Server.MapPath("~/App_Code/Reportes/ReporteClientesProductos.rdlc");
