<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReporteGeneral.aspx.cs" Inherits="Presentacion_Reportes_ReporteGeneral" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="col-md-8" runat="server" id="formReporte">
        ...
        <div class="col-md-3 form-group">
            ...
            <asp:ListBox ID="lbxLocalidad" runat="server" CssClass="form-control" SelectionMode="Multiple" AutoPostBack="True" OnSelectedIndexChanged="lbxLocalidad_SelectedIndexChanged"></asp:ListBox>
        </div>
        <div class="col-md-3 form-group">
        ...
        <div class="col-md-3 form-group">
            <asp:Label CssClass="labels" Font-Bold="true" ID="labAsesorIdentificador" runat="server">Asesor</asp:Label>
            <asp:ListBox ID="lbxAsesor" runat="server" CssClass="form-control" SelectionMode="Multiple" AutoPostBack="false"></asp:ListBox>
        </div>
        <div class="col-md-3 form-group">
            <asp:Label CssClass="labels" Font-Bold="true" ID="labCertificadoRecuperadoIdentificador" runat="server">Certificado Recuperado</asp:Label>
            <asp:ListBox ID="lbxCertificadoRecuperado" runat="server" CssClass="form-control" SelectionMode="Multiple" AutoPostBack="false"></asp:ListBox>
        </div>
        <div class="col-md-3 form-group">
