<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="InformeAseguradosExtraprimaPrevisora.aspx.cs" Inherits="Presentacion_Reportes_InformeAseguradosExtraprimaPrevisora" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
     ...
     <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <h3>Informe Asegurados con Extraprima Previsora</h3>
    ...
    <div class="col-md-8" runat="server" id="formReporte">
        ...
        <div class="col-md-4 form-group">
            <asp:Label CssClass="labels" Font-Bold="true" ID="labFechaInicioVigenciaRetiroPrincipal" runat="server" Visible="false">Inicio Vigencia Retiro Principal</asp:Label>
            <asp:TextBox type="text" placeholder="Fecha Inicio Vigencia Retiro Principal" runat="server" ID="txtFechaInicioVigenciaRetiroPrincipal" CssClass="form-control" MaxLength="10" Visible="false"></asp:TextBox>
        </div>
        <div class="col-md-4 form-group">
