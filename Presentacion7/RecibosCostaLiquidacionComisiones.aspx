<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RecibosCostaLiquidacionComisiones.aspx.cs" Inherits="Presentacion_Reportes_RecibosCostaLiquidacionComisiones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
             <h3>Recibos Costa para Liquidación de Comisiones</h3>
