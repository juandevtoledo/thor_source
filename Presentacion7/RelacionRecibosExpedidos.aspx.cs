...
public partial class Presentacion_Reportes_RelacionRecibosExpedidos : System.Web.UI.Page
{
    ...
    protected void btnGenerarReporte_Click(object sender, EventArgs e)
    {
        ...
        DataTable dsReporte = Reporte.GenerarRelacionRecibosExpedidos(Utils.ObtenerIdsSeleccionados(lbxDepartamento), Utils.ObtenerIdsSeleccionados(lbxCompania),
            Utils.ObtenerIdsSeleccionados(lbxProducto), fechaInicio, fechaFin);
        ...
        rvReporte.LocalReport.ReportPath = Server.MapPath("~/App_Code/Reportes/RelacionRecibosExpedidos.rdlc");
