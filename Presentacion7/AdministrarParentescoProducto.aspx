<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AdministrarParentescoProducto.aspx.cs" Inherits="Presentacion_CRUDS_AdministrarParentescoProducto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h3>Administrar Parentesco Producto</h3>
    <br />
    <div class="row margenFormularios" runat="server" id="tablaParentescosProductos">
        <div class="col-md-1">
        ...
        <!--tabla para consultar todos los parentescos por productos-->
        <div class="col-md-10">
            <asp:GridView ID="grvAdminParentescoProducto" CssClass="table table-bordered table-hover table-striped" runat="server" OnRowCommand="grvAdminParentescoProducto_RowCommand" OnRowDataBound="grvAdminParentescoProducto_RowDataBound" AllowPaging="True" PageSize="20" OnPageIndexChanging="grvAdminParentescoProducto_PageIndexChanging">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
    ...
    <!--tabla para consultar un parentesco por  producto-->
    <div class="row margenFormularios" runat="server" id="tablaParentescoProducto">
        <div class="col-md-1">
            <asp:Button type="submit" class="btn btn-danger" runat="server" ID="botonAtras" OnClick="btnSalir_Click" Text="Atrás"></asp:Button>
        </div>
        <div class="col-md-8">
            <asp:GridView ID="grvConsultarParentescoProducto" CssClass="table table-bordered table-hover table-striped" runat="server" AllowPaging="True" PageSize="20">
            </asp:GridView>
        </div>
    </div>
    <!-- Registrar un parentesco por  producto -->
    <div class="col-md-1"></div>
    <div class="col-md-8" runat="server" id="formParentescoProducto">
