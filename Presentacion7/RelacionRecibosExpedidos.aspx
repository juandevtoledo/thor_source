<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RelacionRecibosExpedidos.aspx.cs" Inherits="Presentacion_Reportes_RelacionRecibosExpedidos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
             <h3>Relación Recibos Expedidos</h3>
    ...
    <div class="col-md-8" runat="server" id="formReporte">
        <div class="col-md-4 form-group">
            ...
            <asp:ListBox ID="lbxDepartamento" runat="server" CssClass="form-control" SelectionMode="Multiple" AutoPostBack="false"></asp:ListBox>
        </div>
        <div class="col-md-4 form-group">
