...
public partial class Presentacion3_AdjuntarSoportesDevolucion : System.Web.UI.Page
{
    ...
    {
        string url = "";
        string rutaBase = "~/Presentacion3/SoportesDevolucion/";
            ...
            if (fuCargarArchivosSoporte.HasFile)
            {
                ...
                if (VerificarExtension(nombreArchivo) && VerificarTamaño(nombreArchivo, fuCargarArchivosSoporte.PostedFile.ContentLength / 1024))
                {
                    ...
                    else
                    {
                        ...
                        RegistrarSoporteDevolucion(rutaBase + nombreArchivo);
    ...
    public void RegistrarSoporteDevolucion(string urlSoporte)
    {

        try
        {

            int resSop = AdministrarDevolucionDePrima.RegistrarArchivosDevoluciones(null, Session["idDevolucion"].ToString(),
                    txtNomSoporte.Text, urlSoporte);

            if (resSop >= 0)
            {
                lblMsjCarga.Text += "<br> - Proceso de Asocio al Convenio: Ok ";
                MensajeFormV2(" - El Archivo Soporte ha sido adjuntado correctamente a la Devolucion");
            }
            else
            {
                lblMsjCarga.Text += "<br> - Proceso de Asocio al Convenio: Error ";
                MensajeFormV2(" - No se ha podido asociar el archivo a la Devolucion. Por favor Intentelo Nuevamente");
            }
    ...
    public void MensajeFormV2(string msg)
    {
        ...
        jScript = "alert('" + msg + "'); VerDevolucion();";
