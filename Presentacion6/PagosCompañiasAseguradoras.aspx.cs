...
public partial class Presentacion6_PagosCompañiasAseguradoras : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ddlProductoFacturacion.Items.Insert(6, new ListItem("702", "701"));
            ddlProductoFacturacion.Items.Insert(7, new ListItem("711", "711"));
            ddlProductoFacturacion.Items.Insert(8, new ListItem("712", "712"));
            ddlProductoFacturacion.Items.Insert(9, new ListItem("713", "713"));
    ...
    protected void btnExportarPagoDefinitivo_Click(object sender, EventArgs e)
    {
        int idLocalidad = 0;
        //try
        if ((ddlLocalidadPago.SelectedValue.ToString()) != "")
