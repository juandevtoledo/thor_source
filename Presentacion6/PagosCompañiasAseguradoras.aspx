           ...
           <div id="tabs1" >
            ...
            <div id="tabs3" >
                <div class="row">
                    <div class="col-md-12"> 
                        ...
                        <asp:Button ID="btnExportarExcelFacturaciones" runat="server" cssclass="btn btn-success btn-danger" Text="Exportar a Excel" OnClick="btnExportarExcelFacturaciones_Click"  />
                    </div>
                </div>
          </div>
            ...
            <div id="tabs4">
                <div class="row">
                    ...
                    <asp:Button ID="btnExportarPago" runat="server" Text="Exportar Pago" cssclass="btn btn-primary btn-warning" OnClick="btnExportarPago_Click"/>
                    <asp:Button ID="btnExportarPagoDefinitivo" runat="server" Text="Exportar Pago Definitivo" cssclass="btn btn-primary btn-danger" OnClick="btnExportarPagoDefinitivo_Click" />
                    <asp:Button ID="btnExportarDetalles" runat="server" Text="Exportar Detalles" cssclass="btn btn-primary btn-group" OnClick="btnExportarDetalles_Click"/>
            ...
            <div id="tabs5">
                 <div class="row">
                    <asp:UpdatePanel runat="server" ID="UpdatePanel5">
                     ...
                     <asp:Button ID="btnExportarEcelPagoHiastorico" runat="server" Text="Exportar Pago" cssclass="btn btn-primary btn-danger" OnClick="btnExportarEcelPagoHiastorico_Click"  />
                    <asp:Button ID="btnExportarDetallesHsitorico" runat="server" Text="Exportar Detalles" cssclass="btn btn-primary btn-group" OnClick="btnExportarDetallesHsitorico_Click" />
