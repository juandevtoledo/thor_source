     ...
     <asp:ScriptManager ID="ScriptManager1" runat="server" AsyncPostBackTimeout="9000000"></asp:ScriptManager> 
        ...
        <div id="tabs">
            <ul>
                ...
                <li><a data-toggle="tab" href="#tabs1" >Generar Pago</a></li>
                 ...
                 <div class="row">
                    <asp:UpdatePanel runat="server" ID="udpCarguePagoCompañia">
                     ...
                     <asp:UpdateProgress ID="uppCarguePagoCompañia" runat="server" AssociatedUpdatePanelID="udpCarguePagoCompañia" OnLoad="Page_Load" >
                         ...
                         <asp:Button ID="btnExportarExcelCarguePago" runat="server" Text="Exportar a Excel" cssclass="btn btn-primary" OnClick="btnExportarExcelCarguePago_Click"  />
                 ...
                 <div class="row">
                    <asp:UpdatePanel runat="server" ID="udpArchivoCargue">
                     ...
                     <fieldset>
                         ...
                         <asp:Button ID="btnExportarArchivoCargue" runat="server" Text="Exportar a Excel" cssclass="btn btn-primary" OnClick="btnExportarArchivoCargue_Click"  />
                     </div>
                     </fieldset>
