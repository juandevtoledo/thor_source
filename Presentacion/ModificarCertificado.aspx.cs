...
public partial class Presentacion_ModificarCertificado : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataTable dt = new DataTable(), dtAgencia = new DataTable(), dtPeriodoPago = new DataTable(), dtLocalidades = new DataTable(), dtOcupacionPrincipal = new DataTable(), dtconsultarParentescoBeneficiarioPrincipal = new DataTable(), dtPlantel = new DataTable(),dtPagaduria = new DataTable();
                ...
                DataTable dtLocalidadesTodas = objAdministrarCertificados.ConsultarLocalidad();
                ddlLocalidadCertificado.DataValueField = "dep_Id";
                ddlLocalidadCertificado.DataTextField = "dep_Nombre";
                ddlLocalidadCertificado.DataSource = dtLocalidadesTodas;
                ...
                dtPagaduria = objAdministrarCertificados.ConsultarPagaduriaPorLocalidad(int.Parse(dtLocalidades.Rows[0]["dep_Id"].ToString()));
                ddlPagaduriaPrincipal.DataValueField = "paga_Id";
                ddlPagaduriaPrincipal.DataTextField = "paga_Nombre";
                ddlPagaduriaPrincipal.DataSource = dtPagaduria;
                ddlPagaduriaPrincipal.DataBind();
                ddlPagaduriaPrincipal.Items.Insert(0, new ListItem("", ""));
                ddlPagaduriaPrincipal.Attributes.Add("onclick", "localStorage.setItem('accIndex', 1);");
                ...
                if (objAdministrarCertificados.objCertificadoPre.Migracion == "2")
                {
                    ...
                    if (dtCertificadoFull.Rows.Count > 0)
                    {
                        ...
                        Session["dtPlanPrincipal"] = dtPlan;
                    }
                }
                ...
                if (dtCertificadoFull.Rows.Count > 0)
                {
                    ...
                    if ((string)Session["operacionCertificado"] == "modificar" || int.Parse(Session["pro_Id"].ToString()) == 99)
                    {
                        ...
                        dtPolizaInicio = objAdministrarCertificados.spConsultarPolizaPorProudcto(int.Parse(ddlLocalidadCertificado.SelectedValue.ToString()), int.Parse(dtCertificadoFull.Rows[0]["pro_Id"].ToString()));
                        ...
                        if (txtCedulaConyuge.Text != "")
                        {
                            ...
                            dtPlanPrin = objAdministrarCertificados.consultarPlanPorPoliza(int.Parse(ddlPoliza.SelectedValue.ToString()), 2, int.Parse(txtEdadConyuge.Text));
                            ...
                            Session["dtPlanConyuge"] = dtPlanPrin;
                            Session["plapol_IdConyuge"] = dtPlanPrin.Rows[0]["plapol_Id"].ToString();

                            if (objAdministrarCertificados.objCertificadoPre.Migracion != "2")
                            {
                                //dtPlanPrin = objAdministrarCertificados.consultarPlanPorPoliza(int.Parse(ddlPoliza.SelectedValue.ToString()), 1, int.Parse(txtEdadPrincipal.Text));
                                //ddlPlanPrincipal.DataSource = dtPlanPrin;
                                //ddlPlanPrincipal.DataValueField = "plapol_Id";
                                //ddlPlanPrincipal.DataTextField = "plan_ValAsegurado";
                                //ddlPlanPrincipal.DataBind();
                                //Session["dtPlanPrincipal"] = dtPlanPrin;
                            }

                            dtBeneficiarioConyuge = objAdministrarCertificados.ConsultarBeneficiarioModificacion(cer_Id, int.Parse(txtCedulaConyuge.Text), 2);
                            grvBeneficiarioConyuge.DataSource = dtBeneficiarioConyuge;
                            grvBeneficiarioConyuge.DataBind();
                            ...
                            if (int.Parse(Session["pro_Id"].ToString()) == 99 && dtBeneficiarioConyuge.Rows.Count == 0)
                            {
                                ...
                                dtBeneficiarioConyuge = objAdministrarCertificados.ConsultarBeneficiarioModificacion(cer_Antiguo, int.Parse(txtCedulaConyuge.Text), 2);
                                grvBeneficiarioConyuge.DataSource = dtBeneficiarioConyuge;
                                grvBeneficiarioConyuge.DataBind();
                            }
                    ...
                    //No esta en digitacion
                    ddlPagaduriaPrincipal.SelectedValue = dtCertificadoFull.Rows[0]["paga_Id"].ToString();
                }
            ...
            if (!IsPostBack)
            {
                if (dtCertificadoFull.Rows.Count > 0)
                {
                    ...
                    {
                        if (int.Parse(Session["pro_Id"].ToString()) != 1)
                        {
                            grvBeneficiarioConyuge.DataSource = dtBeneficiarioConyuge;
                            grvBeneficiarioConyuge.DataBind();
                ...
                {
                    //int pagaduria = int.Parse(objAdministrarCertificados.consultarConvenioPorPagaduria(txtPagaduriaPrincipal.Text, dtCertificadoFull.Rows[0]["Localidad"].ToString()).Rows[0]["paga_Id"].ToString());
                    //int pagaduria = int.Parse(objAdministrarCertificados.consultarConvenioPorPagaduria(ddlPagaduriaPrincipal.SelectedItem.ToString(), dtCertificadoFull.Rows[0]["Localidad"].ToString()).Rows[0]["paga_Id"].ToString());
                    //No esta en digitacion
                    //int pagaduria = int.Parse(ddlPagaduriaPrincipal.SelectedValue.ToString());
                ...
                if (ddlPoliza.SelectedValue != "")
                {
                    ...
                    if (objAdministrarCertificados.objCertificadoPre.Migracion != "2")
                    {
                        try
                        {
                            ...
                            ddlPlanPrincipal.DataTextField = "plan_ValAsegurado";
                            ddlPlanPrincipal.DataBind();
                            Session["dtPlanPrincipal"] = dtPoliza;
                        }
                        catch { }
    ...
    public void ReestructurarExtraPrimaPrincipal()
    {
        try
        {
            if ((string)Session["operacionCertificado"] == "modificar")
            {
                ...
                cer_IdNuevo = objAdministrarCertificados.ConsultarIdCertificado(int.Parse(Session["ter_Id"].ToString()), int.Parse(Session["pro_Id"].ToString()), "VIGENTE", "PRODUCCION NUEVA");
            ...
            //    grvAmparoExtraPrima.DataBind();
            //    Session["dtExtraprimaPrincipal"] = dtEliminarPrincipal;
            //}
        }
        catch
        {
        ...
        try
        {
            ...
            if ((string)Session["operacionCertificado"] == "modificar" && dtCer_IdExtraPrima.Rows[0]["idConyuge"].ToString() != "")
            {
                ...
                if (ddlPlanPrincipal.SelectedItem.ToString() != "")
                {
                    ...
                    DataTable dtConsultarValorAseguradoExtraPrima = new DataTable();
                    dtConsultarValorAseguradoExtraPrima = objAdministrarCertificados.ConsultarValorAseguradoExtraPrima(cer_IdAnterior, 2);
    ...
    protected void ConsultarAmparosPlan(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            dtCumuloValor = objAdministrarCertificados.spConsultarCumulo(int.Parse(dtEncabezadoCertificado.Rows[0]["com_Id"].ToString()));
            valorAsegurado = objAdministrarCertificados.spConsultarValoresAsegurado(int.Parse(dtEncabezadoCertificado.Rows[0]["com_Id"].ToString()), int.Parse(txtCedulaPrincipal.Text));
            ...
            if (cer_IdAnterior != 0)
            {
                dtValorVigente = objAdministrarCertificados.ConsultarEstadoNegocioPorCerId(cer_IdAnterior);
            ...
            if ((valorAsegurado + double.Parse(ddlPlanPrincipal.SelectedItem.ToString())) <= double.Parse(dtCumuloValor.Rows[0]["cum_Nombre"].ToString()))
            {
                if (ddlPlanPrincipal.SelectedItem.ToString() != "")
                {
                    ...
                    if ((string)Session["operacionCertificado"] == "modificar")
                    {
                        ...
                        if (dtPlanTieneTasa.Rows[0]["plan_TieneTasa"].ToString() == "1")
                        {
                            ...
                            foreach (DataRow dt in dtExtraprimaPrincipal.Rows)
                            {
                                ...
                                // asigna este dt a la session 
                                //ession["dtExtraprimaPrincipalRestaurar"] = dtExtraprimaPrincipalRestaurar;
                            }
                        }
                         if (dtPlanTieneTasa.Rows[0]["plan_TieneTasa"].ToString() == "0")
                        {
                    ...
                    double consultarHistorialExtraPrima = 0;
                    double valorExtraPrimaSuma = 0;
                    double valorExtraPrima = 0;
                    double valorIgualar = 0;
                    int count = 0;
                    //Condicional en el cual entra si el cliente ya tiene un historial damparos  para asignar valores
                    if (dtConsultarHistorialExtraPrima.Rows.Count > 0)
                    {
                        foreach (DataRow dtConsultarHistorialExtraPrimaForeach in dtConsultarHistorialExtraPrima.Rows)
                        {
                            valorExtraPrimaSuma += double.Parse(dtConsultarHistorialExtraPrimaForeach["Extra Prima"].ToString());
                    ...
                    if (dtPlanTieneTasa.Rows[0]["plan_TieneTasa"].ToString() == "1" || (string)Session["operacionCertificado"] != "modificar")
                    {
                        ...
                        if (dtPlanTieneTasa.Rows[0]["plan_TieneTasa"].ToString() != "2")
                        {
                            ...
                            foreach (DataRow dtConsultarHistorialExtraPrimaForeach in dtConsultarHistorialExtraPrima.Rows)
                            {
                                if (countSuma == 0)
                                {
                                    foreach (DataRow dtConsultarHistorialExtraPrimaForeachSuma in dtConsultarHistorialExtraPrima.Rows)
                                    {
                                        valorIgualar += double.Parse(dtConsultarHistorialExtraPrimaForeachSuma["Valor Asegurado"].ToString());
                                    }
                                }
                                countSuma++;
                                if (ddlPlanPrincipal.SelectedItem.ToString() == valorIgualar.ToString())
                                {
                                    txtPrincipalExtraprima.Text = valorExtraPrimaSuma.ToString();
                                    txtExtraPrimaPrincipal.Text = txtPrincipalExtraprima.Text;
                                }
                                else
                                {
    ...
    protected void ConsultarAmparosPlanConyuge(object sender, EventArgs e)
    {
        try
        {
            ...
            dtCumuloValorConyuge = objAdministrarCertificados.spConsultarCumulo(int.Parse(dtEncabezadoCertificado.Rows[0]["com_Id"].ToString()));
            valorAsegurado = objAdministrarCertificados.spConsultarValoresAsegurado(int.Parse(dtEncabezadoCertificado.Rows[0]["com_Id"].ToString()), int.Parse(txtCedulaConyuge.Text));
            valorAsegurado = valorAsegurado - double.Parse(Session["valorAseguradoPrincipalResta"].ToString());
            DataTable dtValorVigente = new DataTable();
            if (cer_IdAnterior != 0)
            {
            ...
            if ((valorAsegurado + double.Parse(ddlPlanConyuge.SelectedItem.ToString())) <= double.Parse(dtCumuloValorConyuge.Rows[0]["cum_Nombre"].ToString()))
            {
                if (ddlPlanConyuge.SelectedItem.ToString() != "")
                {
                    ...
                    DataSet dsConsultarHistirialPorcentajeExtraPrimadoConyuge = new DataSet();
                    dsConsultarHistirialPorcentajeExtraPrimadoConyuge = objAdministrarCertificados.ConsultarHistirialPorcentajeExtraPrimado(cer_IdAnterior, 2);
                    ...
                    //Consulta el historial del cliente pero general
                    DataTable dtConsultarHistorialExtraPrimaConyuge = new DataTable();
                    dtConsultarHistorialExtraPrimaConyuge = objAdministrarCertificados.ConsultarHistorialExtraPrima(cer_IdAnterior, 2, int.Parse(Session["banderaExtraPrima"].ToString()));
                    grvHistorialExtraPrimaConyuge.DataSource = dtConsultarHistorialExtraPrimaConyuge;
                    grvHistorialExtraPrimaConyuge.DataBind();

                    double consultarHistorialExtraPrimaConyuge = 0;
                    double valorExtraPrimaSumaConyuge = 0;
                    double valorExtraPrimaConyuge = 0;
                    double valorIgualar = 0;
                    int count = 0;
                    //Condicional en el cual entra si el cliente ya tiene un historial damparos  para asignar valores
                    if (dtConsultarHistorialExtraPrimaConyuge.Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow dtConsultarHistorialExtraPrimaForeachConyuge in dtConsultarHistorialExtraPrimaConyuge.Rows)
                        {
                            valorExtraPrimaSumaConyuge += double.Parse(dtConsultarHistorialExtraPrimaForeachConyuge["Extra Prima"].ToString());
                             if (int.Parse(count.ToString()) >= 1)
                             {
                                 consultarHistorialExtraPrimaConyuge += double.Parse(dtConsultarHistorialExtraPrimaForeachConyuge["Prima"].ToString());
                                 valorExtraPrimaConyuge += double.Parse(dtConsultarHistorialExtraPrimaForeachConyuge["Extra Prima"].ToString()); 
                    ...
                    if (dtPlanTieneTasa.Rows[0]["plan_TieneTasa"].ToString() == "1" || (string)Session["operacionCertificado"] != "modificar")
                    {
                        ...
                        if (dtPlanTieneTasa.Rows[0]["plan_TieneTasa"].ToString() != "2")
                        {
                            ...
                            foreach (DataRow dtConsultarHistorialExtraPrimaForeachConyuge in dtConsultarHistorialExtraPrimaConyuge.Rows)
                            {
                                if (countSuma == 0)
                                {
                                    foreach (DataRow dtConsultarHistorialExtraPrimaForeachConyugeSuma in dtConsultarHistorialExtraPrimaConyuge.Rows)
                                    {
                                        valorIgualar += double.Parse(dtConsultarHistorialExtraPrimaForeachConyugeSuma["Valor Asegurado"].ToString());
                                    }
                                }
                                countSuma++;
                                if (ddlPlanConyuge.SelectedIndex.ToString() == dtConsultarHistorialExtraPrimaForeachConyuge["Valor Asegurado"].ToString())
                                {
                                    txtPrincipalExtraprimaConyuge.Text = valorExtraPrimaSumaConyuge.ToString();
                                    txtExtraPrimaConyuge.Text = txtPrincipalExtraprimaConyuge.Text;
                                }
                                else
                                {
    ...
    protected void consultarPolizaPorProducto(object sender, EventArgs e)
    {
        ...
        if (ddlLocalidadCertificado.SelectedItem.ToString() != "")
        {
            ...
            DataTable dtPagaduria = objAdministrarCertificados.ConsultarPagaduriaPorLocalidad(int.Parse(ddlLocalidadCertificado.SelectedValue.ToString()));
            ddlPagaduriaPrincipal.DataValueField = "paga_Id";
            ddlPagaduriaPrincipal.DataTextField = "paga_Nombre";
            ddlPagaduriaPrincipal.DataSource = dtPagaduria;
            ddlPagaduriaPrincipal.DataBind();
            ...
            if(dtCertificadoFull.Rows.Count > 0)
            {
                if(dtCertificadoFull.Rows[0]["Localidad"].ToString() == ddlLocalidadCertificado.SelectedValue.ToString())
                {
                    ddlPagaduriaPrincipal.SelectedValue = dtCertificadoFull.Rows[0]["paga_Id"].ToString();
                }
                else
                {
                    ddlPagaduriaPrincipal.SelectedValue = dtPagaduria.Rows[0]["paga_Id"].ToString();
                }
            }
            
            DataTable dtPolizaInicio = new DataTable();
            dtPolizaInicio = objAdministrarCertificados.spConsultarPolizaPorProudcto(int.Parse(ddlLocalidadCertificado.SelectedValue.ToString()),int.Parse(ddlProducto.SelectedValue.ToString()));
            if (dtPolizaInicio.Rows.Count > 0)
            {
                ddlPoliza.SelectedValue = dtPolizaInicio.Rows[0]["pol_Id"].ToString();
            }
    ...
    protected void CalcularNovedades(DataTable dtPeriodicidad, DataTable dtArchivoPagaduria)
    {
        ...
        //pagaduria = int.Parse(objAdministrarCertificados.consultarConvenioPorPagaduria(txtPagaduriaPrincipal.Text, dtEncabezadoCertificado.Rows[0]["Localidad"].ToString()).Rows[0]["paga_Id"].ToString());
        //pagaduria = int.Parse(objAdministrarCertificados.consultarConvenioPorPagaduria(ddlPagaduriaPrincipal.SelectedItem.ToString(), dtEncabezadoCertificado.Rows[0]["Localidad"].ToString()).Rows[0]["paga_Id"].ToString());
        pagaduria = int.Parse(ddlPagaduriaPrincipal.SelectedValue.ToString());
    ...
    protected void bntGuardarCertificado_Click(object sender, EventArgs e)
    {
        ...
        int pagaduriaNuevo = int.Parse(ddlPagaduriaPrincipal.SelectedValue.ToString());
        int cer_IdNuevo = 0;
        AdministrarCertificados objAdministrarCertificados = new AdministrarCertificados();
        objAdministrarCertificados.certificadoPrecargado(int.Parse(Session["cer_Id"].ToString()));
        cer_IdNuevo = objAdministrarCertificados.ConsultarIdCertificado(int.Parse(Session["ter_Id"].ToString()), int.Parse(Session["pro_Id"].ToString()), "VIGENTE", "PRODUCCION NUEVA");
        ...
        DataTable dtEncabezadoPrecargue = objAdministrarCertificados.ConsultarCertificadoPrecargadoPorDigitar(int.Parse(Session["cer_Id"].ToString()));
        precargue.CrearNuevoCertificadoModificado(dtEncabezadoPrecargue.Rows[0]["cer_Certificado"].ToString(), 
            dtEncabezadoPrecargue.Rows[0]["ter_Id"].ToString(), " ", " ", dtEncabezadoPrecargue.Rows[0]["age_Id"].ToString(), 
            DateTime.Parse(dtEncabezadoPrecargue.Rows[0]["cer_FechaExpedicion"].ToString()), 
            int.Parse(dtEncabezadoPrecargue.Rows[0]["ase_Id"].ToString()), dtEncabezadoPrecargue.Rows[0]["paga_Id"].ToString(), 
            DateTime.Parse(dtEncabezadoPrecargue.Rows[0]["cer_FechaRecibido"].ToString()), 
            dtEncabezadoPrecargue.Rows[0]["cer_PlanillaBolivar"].ToString(), dtEncabezadoPrecargue.Rows[0]["casesp_Id"].ToString(), 
            dtEncabezadoPrecargue.Rows[0]["cer_NumeroFolios"].ToString(), dtEncabezadoPrecargue.Rows[0]["com_Id"].ToString(), 
            dtEncabezadoPrecargue.Rows[0]["Localidad"].ToString(), dtEncabezadoPrecargue.Rows[0]["pro_Id"].ToString(), 
            dtEncabezadoPrecargue.Rows[0]["cer_HojaServicio1"].ToString(), dtEncabezadoPrecargue.Rows[0]["cer_HojaServicio2"].ToString(), 
            dtEncabezadoPrecargue.Rows[0]["cer_HojaServicio3"].ToString(), 0, 
            int.Parse(dtEncabezadoPrecargue.Rows[0]["caudev_Id"].ToString()), 
            int.Parse(dtEncabezadoPrecargue.Rows[0]["tipdev_Id"].ToString()), 0, 
            dtEncabezadoPrecargue.Rows[0]["cer_Observaciones"].ToString(), 
            dtEncabezadoPrecargue.Rows[0]["cer_AnexoConversion"].ToString(), 
            DateTime.Parse(dtEncabezadoPrecargue.Rows[0]["cer_VigenciaDesde"].ToString()), 
            int.Parse(dtEncabezadoPrecargue.Rows[0]["cer_SoporteFisico"].ToString()), 
            int.Parse(dtEncabezadoPrecargue.Rows[0]["MesProduccion"].ToString()), 
            int.Parse(dtEncabezadoPrecargue.Rows[0]["cer_Migracion"].ToString()), 
            int.Parse(dtEncabezadoPrecargue.Rows[0]["cer_Consecutivo"].ToString()));

        // BORRAR TODO CERTIFICADO ANTERIOR
        objAdministrarCertificados.EliminarCertificado(int.Parse(Session["cer_Id"].ToString()));
        cer_IdNuevo = objAdministrarCertificados.ConsultarIdCertificado(int.Parse(Session["ter_Id"].ToString()), int.Parse(Session["pro_Id"].ToString()), "", "");
        Session["cerId_ValorNuevo"] = cer_IdNuevo;
               ...
               if (total == 100)
               {
                   ...
                   if (idConyuge != "0")
                   {
                       ...
                       if (totalBeneficiarioConyuge == 100)
                       {
                           ...
                           objAdministrarCertificados.ActualizarNewCertificadoConPagaduria(cer_IdNuevo, int.Parse(txtPrima.Text), objAdministrarCertificados.objCertificadoPre.Consecutivo.ToString(), ddlConvenioPrincipal.SelectedValue.ToString(),
                          ...
                          3, recuperado, Convert.ToDateTime(txtFechaDigitacionCertificado.Text), int.Parse(ddlperiodoPagoCertificado.SelectedValue.ToString()),pagaduriaNuevo);
    ...
    protected void grvAmparoPrincipal_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        ////historial de ceritificados antetiones generales
        //DataTable dtConsultarHistorialExtraPrima = new DataTable();
        //dtConsultarHistorialExtraPrima = objAdministrarCertificados.ConsultarHistorialExtraPrima(cer_IdAnterior, 1, int.Parse(Session["banderaExtraPrima"].ToString()));
        //grvHistorialExtraPrima.DataSource = dtConsultarHistorialExtraPrima;
        //grvHistorialExtraPrima.DataBind();
        ...
        //        //if (count == 0)
        //        //{
        //        //    consultarHistorialExtraPrima = 0;
        //        //    valorExtraPrima = 0;
        //        //}
        //        //count++;
        //    }
    ...
    protected void grvExtraPrimaConyuge_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        //        //if (count2 == 0)
        //        //{
        //        //    consultarHistorialExtraPrimaConyuge = 0;
        //        //    valorExtraPrimaConyuge = 0;
        //        //}
        //        //count2++;
        //    }
        //}
    ...
    protected void btnValidarPrincipal_Click(object sender, EventArgs e)
    {
        ...
        if (total == 100)
        {
            if (objAdministrarCertificados.objCertificadoPre.Migracion != "3" && objAdministrarCertificados.objCertificadoPre.Migracion != "2")
            {
                if (objAdministrarCertificados.objCertificadoPre.Producto == "1")
                {
                    if (ddlConvenioPrincipal.SelectedValue != "" && txtPlanPrincipal.Text != "" && ddlPagaduriaPrincipal.SelectedValue !="")
                    {
                        btnSiguientePrincipal.Enabled = true;
                        ddlConvenioPrincipal.Enabled = false;
                        txtPlanPrincipal.Enabled = false;
                        ddlPlantel.Enabled = false;
                        ddlPagaduriaPrincipal.Enabled = false;
                        btnCertificadoModal.Enabled = true;
                ...
                if (objAdministrarCertificados.objCertificadoPre.Producto == "99" || objAdministrarCertificados.objCertificadoPre.Producto == "2"
                    ...
                    || objAdministrarCertificados.objCertificadoPre.Producto == "15")
                {
                    if (ddlConvenioPrincipal.SelectedValue != "" && ddlPlanPrincipal.SelectedValue != "" && ddlPagaduriaPrincipal.SelectedValue != "")
                    {
                        btnSiguientePrincipal.Enabled = true;
                        ddlConvenioPrincipal.Enabled = false;
                        ddlPlanPrincipal.Enabled = false;
                ...
                if (objAdministrarCertificados.objCertificadoPre.Producto == "3")
                {
                    if (ddlConvenioPrincipal.SelectedValue != "" && txtPlanPrincipal.Text != "" && txtpesoPrincipal.Text != ""
                        && txtestaturaPrincipal.Text != "" && ddlPagaduriaPrincipal.SelectedValue != "")
                    {
    ...
    //                 || AdministrarCertificados.certificadoPre.Producto == "53" || AdministrarCertificados.certificadoPre.Producto == "54"
    //                  || AdministrarCertificados.certificadoPre.Producto == "55" || AdministrarCertificados.certificadoPre.Producto == "56"
    ...
    protected void btnX_Click(object sender, EventArgs e)
    {
        ...
        double totalP3 = 0;
        AdministrarCertificados objAdministrarCertificados = new AdministrarCertificados();
        DataTable dtPlanPrincipal = (DataTable)Session["dtPlanPrincipal"];
        ...
        if (dtConsultarHistorialExtraPrima.Rows.Count > 0)
        {
            foreach (DataRow dtConsultarHistorialExtraPrimaForeach in dtConsultarHistorialExtraPrima.Rows)
            {
                consultarHistorialExtraPrima += double.Parse(dtConsultarHistorialExtraPrimaForeach["Prima"].ToString());
                valorExtraPrima += double.Parse(dtConsultarHistorialExtraPrimaForeach["Extra Prima"].ToString());
                valorTotalPlan += double.Parse(dtConsultarHistorialExtraPrimaForeach["Valor Asegurado"].ToString());
            }
        }
        try
        {
            foreach (DataRow dt in dtPlanPrincipal.Rows)
            {
                if (int.Parse(dt["ampcer_ValAsegurado"].ToString()) == valorTotalPlan)
                {
                    ddlPlanPrincipal.SelectedIndex = ddlPlanPrincipal.Items.IndexOf(ddlPlanPrincipal.Items.FindByText(dt["ampcer_ValAsegurado"].ToString()));
                }
            }
        }
        catch
        {
             foreach (DataRow dt in dtPlanPrincipal.Rows)
            {
                if (int.Parse(dt["plan_ValAsegurado"].ToString()) == valorTotalPlan)
                {
                    ddlPlanPrincipal.SelectedIndex = ddlPlanPrincipal.Items.IndexOf(ddlPlanPrincipal.Items.FindByText(dt["plan_ValAsegurado"].ToString()));
        ...
        DataTable dtEliminarPrincipal = new DataTable();
        dtEliminarPrincipal = objAdministrarCertificados.consultarAmparosPorPlanModificacion(cer_IdNuevo, 1);
        grvAmparoPrincipal.DataSource = dtEliminarPrincipal;
        grvAmparoPrincipal.DataBind();
    ...
    protected void btnX2_Click(object sender, EventArgs e)
    {
        ...
        DataTable dtPlanTieneTasa = new DataTable();
        AdministrarCertificados objAdministrarCertificados = new AdministrarCertificados();
        DataTable dtPlanConyuge = (DataTable)Session["dtPlanConyuge"];
        // Session que funciona como una bandera para realizar una operación posterior a esta 
        ...
        if (dtConsultarHistorialExtraPrimaConyuge.Rows.Count > 0)
        {
            foreach (DataRow dtConsultarHistorialExtraPrimaForeachConyuge in dtConsultarHistorialExtraPrimaConyuge.Rows)
            {
                consultarHistorialExtraPrimaConyuge += double.Parse(dtConsultarHistorialExtraPrimaForeachConyuge["Prima"].ToString());
                valorExtraPrimaConyuge += double.Parse(dtConsultarHistorialExtraPrimaForeachConyuge["Extra Prima"].ToString());
                valorTotalPlan += double.Parse(dtConsultarHistorialExtraPrimaForeachConyuge["Valor Asegurado"].ToString());
            }
        }
        try
        {
            foreach (DataRow dt in dtPlanConyuge.Rows)
            {
                if (int.Parse(dt["ampcer_ValAsegurado"].ToString()) == valorTotalPlan)
                {
                    ddlPlanConyuge.SelectedIndex = ddlPlanConyuge.Items.IndexOf(ddlPlanConyuge.Items.FindByText(dt["ampcer_ValAsegurado"].ToString()));
        ...
        catch
        {
            foreach (DataRow dt in dtPlanConyuge.Rows)
            {
                if (int.Parse(dt["plan_ValAsegurado"].ToString()) == valorTotalPlan)
                {
                    ddlPlanConyuge.SelectedIndex = ddlPlanConyuge.Items.IndexOf(ddlPlanConyuge.Items.FindByText(dt["plan_ValAsegurado"].ToString()));
        ...
        DataTable dtEliminarConyuge = new DataTable();
        dtEliminarConyuge = objAdministrarCertificados.consultarAmparosPorPlanModificacion(cer_IdNuevo, 2);
        grvAmparoConyuge.DataSource = dtEliminarConyuge;
        grvAmparoConyuge.DataBind();
    ...
    protected void ddlPagaduriaPrincipal_SelectedIndexChanged(object sender, EventArgs e)
    {
        AdministrarCertificados objAdministrarCertificados = new AdministrarCertificados();
        DataTable dtCertificadoFull = (DataTable)Session["dtCertificadoFull"];

        if(ddlPagaduriaPrincipal.SelectedValue != "")
        {
            int pagaduria = int.Parse(ddlPagaduriaPrincipal.SelectedValue.ToString());
            try
            {
                DataTable dt = new DataTable();
                dt = objAdministrarCertificados.consultarConvenios(int.Parse(ddlProducto.SelectedValue.ToString()), int.Parse(ddlLocalidadCertificado.SelectedValue.ToString()), pagaduria);
                ddlConvenioPrincipal.Items.Clear();
                ddlConvenioPrincipal.DataTextField = "con_Nombre";
                ddlConvenioPrincipal.DataValueField = "con_Id";
                ddlConvenioPrincipal.DataSource = dt;
                ddlConvenioPrincipal.DataBind();
