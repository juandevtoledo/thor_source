<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" EnableEventValidation = "false" AutoEventWireup="true" CodeFile="DigitarCertificado.aspx.cs" Inherits="Presentacion_DigitarCertificado" %>
                                           ...
                                           <div class="col-md-3">
                                                 <div class="form-group">
                                                      <asp:Label ID="lblPeriodoDePago" runat="server" Text="Periodo de pago" Font-Bold="true"  CssClass="labels"></asp:Label>
                                                        <asp:DropDownList CssClass=" form-control" ID="ddlperiodoPagoCertificado" runat="server"></asp:DropDownList>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                 <div class="form-group">
                                                     ...
                                                     <asp:DropDownList  ID="ddlLocalidadCertificado" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="consultarPolizaPorProducto" OnClientClick="localStorage.setItem('accIndex', 0);" runat="server">
                                                     </asp:DropDownList>
                                            ...
                                            <div class="row">                                   
                                                ...
                                                <div class="col-md-3">
                                                    <asp:Label  runat="server" Text="Convenio" ID="labConvenio" Font-Bold="true"  CssClass="labels"></asp:Label>
                                                        <asp:DropDownList ID="ddlConvenioPrincipal" runat="server" CssClass="ddl">
                                       ...
                                       <ContentTemplate>
                                            <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <asp:TextBox ID="txtPrimaOtros" Visible="true" cssClass="form-control"  OnTextChanged="txtPrimaOtros_TextChanged" runat="server"></asp:TextBox>
                                                    </div>
                                            </div>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                                            ...
                                                            <div class="col-md-4"></div>
                                                                <div class="col-md-3">
                                                                     <asp:UpdatePanel ID="UpdatePanel49" runat="server">
                                                                          <ContentTemplate>
                                                                             <asp:Button ID="btnCertificadoModal" cssClass="btn btn-primary" runat="server" data-toggle="modal" data-target="#myModal" Text="GUARDAR DATOS DEL CERTIFICADO"
                                                                                 ValidationGroup="grpValidacionCertificado"  OnClick="bntGuardarCertificado_Click" 
                                                                                 OnClientClick="return confirm('Esta seguro de guardar el certificado?')"></asp:Button>
                                                                         </ContentTemplate>
                                                                    </asp:UpdatePanel>
                                                                </div>
                                                                <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="UpdatePanel49">
                                                                     <ProgressTemplate>
                                                                         <div class="contenedor-loader">
                                                                             <div class='loader'>
                                                                                 <h6><p style="text-align:center"><b>Guardando certificado, por favor espere...<br /></b></p></h6>
                                                                             </div>
                                                                         </div>
                                                                     </ProgressTemplate>
                                                                </asp:UpdateProgress>
